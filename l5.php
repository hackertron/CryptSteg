			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
							<h2>To XOR or not to XOR ?</h2>
							<p> Here read this ! <a href="/assets/xor.txt" rel="nofollow" class="bbcode_url">file</a> and see what you can find. </p>
							<div id="spoiler" style="display:none"> NO HINT !!
							</div> 
<button title="Click to show/hide content" type="button" onclick="if(document.getElementById('spoiler') .style.display=='none') {document.getElementById('spoiler') .style.display=''}else{document.getElementById('spoiler') .style.display='none'}">HINT</button>
					...
					<form action="r5.php" method="POST">
						<div class="row uniform 50%">
							<div class="8u 12u(mobilep)">
								<input type="text" name="l5" id="email" placeholder="answer" />
							</div>

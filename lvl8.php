			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
							<h2> Can you solve this one? </h2>
							<p> Here take a look at  this ! <a href="/assets/rar2.jpg" rel="nofollow" class="bbcode_url">file</a> and see what you can find. </p>
							<div id="spoiler" style="display:none"> are you sure file is right  !!
							</div> 
					...
					<form action="r6.php" method="POST">
						<div class="row uniform 50%">
							<div class="8u 12u(mobilep)">
								<input type="text" name="l6" id="email" placeholder="answer" />
							</div>
